        ...
        <div className='mb-2 lg:mb-0 lg:max-w-lg lg:pr-5'>
          <div className='max-w-xl mb-4'>
            ...
            <p className='text-gray-800 text-sm font-light font-sora text-justify'>
              ...
              several air quality parameters such as humidity, temperature,
              pressure, and gasses contained in the air at several points in the
              Kalipaten village area. With this application, it is hoped that
              the surrounding community can use it as a medium to determine the
              air quality in the area where they live.
            </p>
